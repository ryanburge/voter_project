ba <- vp %>% 
  ...
  mutate(trump = as.numeric(trumpapp_2017)) %>% 
...
gr %>% 
  ...
  ylab("") + xlab("") +
  labs(title = "Approval of Pres. Trump in July 2017", caption = "Data: Democracy Fund Voter Study Group", subtitle = "Born Again Status Was Asked in 2011 and 2017") +
...
ggsave(file="D://voter_project/trump_approve.png", type = "cairo-png", width = 15, height = 12)
